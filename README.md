...
2. [main-deploy.yaml](./.github/workflows/main-deploy.yaml): triggers upon push to the main branch and runs a resource group deployment against the Azure resource group - using the other managed identity which has write permissions

These workflows use the [Azure/login](https://github.com/Azure/login) and [Azure/bicep-deploy](https://github.com/Azure/bicep-deploy) actions.
